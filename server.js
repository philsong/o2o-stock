...
fu.get("/chat.html", fu.staticHandler("chat.html"));

fu.get("/index.html", fu.staticHandler("index.html"));
fu.get("/radar.js", fu.staticHandler("radar.js"));
fu.get("/utils.js", fu.staticHandler("utils.js"));
fu.get("/sel", fu.staticHandler("sel.html"));
...
fu.get("/select", function (req, res) {
